    ...
    return (
        <Row className={classes.container}>
            <Row className={classes.productContent}>
                ...
                >
                    <Image.PreviewGroup>
                        {data?.images.map((image: string, index: number) => <Image alt="product photo" width={data?.images.length < 4 ? 400 : 250} src={image} key={index} />)}
                    </Image.PreviewGroup>
                </Col>
                <Col
                    lg={{ span: 8 }}
                >
                    ...
                    <Title level={3} className={classes.price}>${data?.price}.00 USD</Title>
                    <Row>
                        <Col
